...
public class DefineReport_Page extends TestBase {
	//POM using Page Factory Implementation
	//@FindBy(locator= "locatorvalue")
	// WebElement element;
	WebDriver driver;
	public DefineReport_Page(WebDriver d) {
		driver= d;
	...
	@FindBy(css="#txtRepName")
	WebElement Reportdata_textbox;
   ...
   // @FindBy(linkText="REP012")
	...
	public void Enterdata_Report_name_textBox(String Rname) {
		Reportdata_textbox.sendKeys(Rname);
